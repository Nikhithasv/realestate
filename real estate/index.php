...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('https://www.apartmentsbangalore.co.in/wp-content/uploads/Vaishnavi-Terraces1-1536x768.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                        <p style="font-family:'Roboto';text-align: center;font-size: 50px;color:white;padding-bottom:50px">your dream<span class="text-success"style="font-family: 'DM Serif Display';text-align: center;color: #c39f75;"> Our Passion</span></p>
      <p style="font-family:'Roboto';text-align: center;font-size: 50px;color:white;padding-bottom:25px;">House in <span class="text-success" style="font-family: 'DM Serif Display';text-align: center;color: #c39f75;"> First Class</span></p>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>sell your property, without brokerage.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Find house from thousands of options for rent, without brokerage.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Legal investment in property made easy.</p>
                            </div>
                        </div>
                    </div>
                </div>
